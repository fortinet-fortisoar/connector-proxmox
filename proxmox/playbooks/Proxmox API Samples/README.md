...
This playbook collection is shipped with the **Proxmox** connector. There is a sample playbook for each connector operation.
...
1. Import the **Proxmox** (`proxmox`) into FortiSOAR and create a connector configuration (host, port, API token).
